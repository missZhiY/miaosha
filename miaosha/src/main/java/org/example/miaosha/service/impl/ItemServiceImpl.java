...
import org.example.miaosha.dao.ItemDOMapper;
import org.example.miaosha.dao.ItemStockDOMapper;
...
public class ItemServiceImpl implements ItemService {
    ...
    private ItemDO convertItemDOFromItemModel(ItemModel itemModel) {
        ...
        //不会copy类型不一致的对象，ItemDO中price类型为double，
        //直接解析到前端可能会出现精度差错，需使用ItemModel中的BigDecimal转为double
    ...
    public List<ItemModel> listItem() {
        ...
        //使用Java8的steam api将itemDO map成itemModel
